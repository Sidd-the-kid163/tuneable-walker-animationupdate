...
FrostBlockDiagonalMatrix::usage = "FrostBlockDiagonalMatrix[b:{__?MatrixQ}] creates block diagonal matrix.";
...
FrostBlockDiagonalMatrix[b : {__?MatrixQ}] := Block[{r, c, n = Length[b], 
	i, j},
